...
class Wireless {
    ...
    async enable () {
        ...
        await propertiesInterface.Set(this.dbusName, 'WirelessEnabled', new dbus.Variant('b', true))
    ...
    async disable () {
        ...
        await propertiesInterface.Set(this.dbusName, 'WirelessEnabled', new dbus.Variant('b', false))
