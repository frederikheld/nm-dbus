...
class NetworkManager extends DBusObject {
    ...
    /**
     * Activates the given connection on the given device and access point.
     * 
     ...
     */
    async activateConnection(connectionObject, deviceObject, accessPointObject) {
        ...
        const activeConnectionPath = await managerInterface.ActivateConnection(
            ...
            accessPointObject.accessPointPath
        )
